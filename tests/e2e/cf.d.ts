...
declare namespace Cloudflare {
    interface Env {
        pluv_kv: KVNamespace;
        rooms_kv: DurableObjectNamespace<
            import("./src/server/yjs/cloudflare/index").RoomKVDurableObject
        >;
        rooms_sqlite: DurableObjectNamespace<
            import("./src/server/yjs/cloudflare/index").RoomSQLiteDurableObject
        >;
    }
}
