/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface CloudflareEnv ./cf.d.ts` (hash: 350c8449f39046679daf8d6bd19c7780)
// Runtime types generated with workerd@1.20250508.0 2025-04-27 
declare namespace Cloudflare {
	interface Env {
		pluv_kv: KVNamespace;
		rooms_kv: DurableObjectNamespace<import("./src/server/yjs/cloudflare/index").RoomKVDurableObject>;
		rooms_sqlite: DurableObjectNamespace<import("./src/server/yjs/cloudflare/index").RoomSQLiteDurableObject>;
	}
}
