...
export class IORoom<T extends IODefs = IODefs> implements IOLike<IOLikeFromDefs<T>> {
    ...
    private readonly _throttledRoomStats: Throttle;
    ...
    constructor(id: string, config: IORoomConfig<T>) {
        ...
        this._throttledRoomStats = throttle(() => this._emitRoomStats(), {
    ...
    public async register(
        ...
        try {
            ...
            await this._throttledRoomStats.schedule();
        ...
        const promise = (async () => {
            ...
            const uninitialize = async (): Promise<void> => {
                ...
                this._teardown = (async () => {
                    this._throttledRoomStats.cancel();
