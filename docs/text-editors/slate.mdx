...
Then we will need to setup Yjs storage on pluv.io, with a [Yjs.XmlText](https://docs.yjs.dev/api/shared-types/y.xmltext) onto which Slate's editor contents will live.
