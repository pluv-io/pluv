---
title: "Slate"
description: "Learn how to setup Slate.js for realtime collaboration with pluv.io"
---
...
Then we will need to setup Yjs storage on pluv.io, with a [Yjs.XmlText](https://docs.yjs.dev/api/shared-types/y.xmltext) unto which Slate's contents will live.
