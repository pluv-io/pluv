...
`@pluv/io` was designed to be self-hosted on the [Cloudflare Workers](https://workers.cloudflare.com/) runtime via [Durable Objects](https://developers.cloudflare.com/workers/runtime-apis/durable-objects/).
