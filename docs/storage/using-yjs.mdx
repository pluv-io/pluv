...
To mutate the value of the `groceries` Y.Array, we simply need to perform a mutation to the shared-type. This will automatically update the shared-type for all connected peers.
