...
<img className="mx-auto" width="100%" src="https://raw.githubusercontent.com/pluv-io/pluv/refs/heads/main/assets/set_initial_storage_webhook.png" alt="Set getInitialStorage set_initial_storage_webhook" loading="lazy" />
