...
To mutate the value of the `groceries` LoroList, we simply need to perform a mutation to the container type. This will automatically update the container type for all connected peers.
