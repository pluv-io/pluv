...
const client = createClient({
     ...
     * This is being used because of TypeScript limitations with partial
     * inference
     */
    ...
    /**
     * Optional: Add this property if additional data is needed to be passed to
     * the endpoints. 
     */
    metadata: z.object({
        baseWsUrl: z.string(),
    ...
    wsEndpoint: ({ metadata, room }) => `${metadata.baseWsUrl}/api/room?room=${room}`,
});
```
