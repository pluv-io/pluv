...
description: "When to use the managed pluv.io network versus self-hosting realtime infrastructure yourself."
---
...
Gain insights on how your users use your app by [creating custom events](/docs/guides/events/client) and monitoring how often each get called.
...
Take control of your own WebSocket server to achieve even more customizability at a lower cost. Hosting `@pluv/io` is incredibly simple, as it was designed for self-hosting first with instructions for [Node.js](/docs/quickstart/nodejs) and [Cloudflare](/docs/quickstart/cloudflare-workers).
