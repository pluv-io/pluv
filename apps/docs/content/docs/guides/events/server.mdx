---
title: "Server Events"
description: "Define type-safe custom events on your self-hosted PluvIO backend with validated procedures and automatic typing."
---
...
* [Receiving custom events](/docs/guides/events/client#Receiving-events)
