---
title: "Client Events"
description: "Define type-safe custom events on the client with input schemas and procedures that run before messages reach the server."
---

> **Note**: If you are self-hosting pluv.io, we recommend using [custom server events](/docs/guides/events/server) instead.
...
* [Client vs server events](/docs/guides/events/overview)
