...
Returns a user info object containing data used when generating the JWT during authentication (see [Authorization](/docs/guides/authorization)), the user's presence, and the user's connection id.
